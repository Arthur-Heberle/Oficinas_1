...
# PI_IP = "192.168.241.221" #Mine
# PI_IP = "192.168.84.221" #Mine
...
def create_text_audio(text):
    try:
        ...
        tts.save("braille_converter/static/outputTEXT.mp3")
    except  Exception as e:
        print(f'Error when trying to create text audio: \n {str(e)}')

def destroy_text_audio():
    try:
        os.remove("braille_converter/static/outputTEXT.mp3")
    except Exception as e:
